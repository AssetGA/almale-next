...
//                 images[currentIndex]?.src || "/img/gallery/1.JPEG"
//               }`}
//             />
...
//                   thumbnailUrl: `${process.env.NEXT_PUBLIC_SITE_URL}${image[currentIndex]?.src}`,
...
//               controls
//               preload="metadata"
//               poster={image[currentIndex]?.src || "/img/gallery/1.JPEG"}
