...
const Head = async ({ lang }) => {
  ...
  return (
    <div className="relative w-full z-0 overflow-hidden">
      <div className="w-full bg-preload bg-[url('/img/main2.png')] sm:bg-[url('/img/front.png')] bg-cover sm:bg-contain bg-no-repeat sm:bg-right flex flex-col sm:flex-row ">
